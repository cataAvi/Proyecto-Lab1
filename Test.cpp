...
void mostrarInfo (char nombreJugador [], int cantPilas, int numRondas, int puntuacion);
void estadisticas (int mayorPuntaje, char nombre);
...
int main(){
	...
	//Muestro info jugador
	mostrarInfo(nombre, pilas, numRonda , puntaje);
	cout << endl;
	//Muestro la matriz
	cout << endl;
...
void mostrarInfo (char nombreJugador [], int cantPilas, int numRondas, int puntuacion){
    cout << endl << "Jugador: ";
    puts(nombreJugador);
    cout << "Cantidad de pilas: " << cantPilas;
    cout << endl << "Ronda numero: " << numRondas;
...
cout << endl << "Mayor puntaje: " << mayorPuntaje;
cout << endl << "Obtenido por: ";
puts(nombre);

}
else {
    cout << endl << "Aun no se ingresaron puntajes" << endl;
}
